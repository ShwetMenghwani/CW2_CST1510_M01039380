...
st.scatter_chart(scatter_data, x="x", y="y", size="size")  # Note: st.scatter_chart doesn't exist; you may want Altair
...
# Info text
st.write("If you want more control, you can use libraries like Altair, Matplotlib, or Plotly:")
